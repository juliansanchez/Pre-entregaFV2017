...
${OBJECTDIR}/Coordenada.o: Coordenada.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Coordenada.o Coordenada.cpp

${OBJECTDIR}/EstadoIntro.o: EstadoIntro.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EstadoIntro.o EstadoIntro.cpp

${OBJECTDIR}/EstadoJugando.o: EstadoJugando.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EstadoJugando.o EstadoJugando.cpp
...
${OBJECTDIR}/Minimapa.o: Minimapa.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Minimapa.o Minimapa.cpp

${OBJECTDIR}/Modificador.o: Modificador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modificador.o Modificador.cpp
...
${OBJECTDIR}/MotorJuego.o: MotorJuego.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotorJuego.o MotorJuego.cpp
...
${OBJECTDIR}/Planta.o: Planta.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Planta.o Planta.cpp

${OBJECTDIR}/SpriteGame.o: SpriteGame.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpriteGame.o SpriteGame.cpp

${OBJECTDIR}/Vistas.o: Vistas.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Vistas.o Vistas.cpp
